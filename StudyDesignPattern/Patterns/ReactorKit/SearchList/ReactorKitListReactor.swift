...
/**
 ...
 - Note: 메인화면 ViewModel
 */
final class ReactorKitListReactor: Reactor, Stepper {
    ...
    enum Action {
        ...
        case selectList(selected: SearchItem)
    }
    ...
    enum Mutation {
        ...
        case moveToDetail(selected: SearchItem)
        case none
    }
    ...
    struct State {
        ...
        var noDataText: String = "STR_SEARCH_NO_INPUT".localized    // No Data or No Input
    ...
    func mutate(action: Action) -> Observable<Mutation> {
        ...
        case .selectList(let item):
            return Observable.just(.moveToDetail(selected: item))
        }
    }
    /**
     # reduce
    ...
    func reduce(state: State, mutation: Mutation) -> State {
        ...
        case .searchResult(let list):
            ...
            if list.items?.isEmpty ?? true {
                ...
                newState.noDataText = "STR_SEARCH_NO_DATA".localized
            } else {
                newState.noDataText = ""
        ...
        case .moveToDetail(let item):
            moveToDetail(selected: item)
        case .none:
            break
        }
        return newState
